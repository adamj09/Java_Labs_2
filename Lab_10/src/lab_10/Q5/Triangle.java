...
public class Triangle extends GeometricObject implements Summable {
    private double side1, side2, side3;

    public Triangle(double side1, double side2, double side3, String colour, boolean filled) throws IllegalArgumentException {
        super(colour, filled);
